...
export default function ProductGroupCard({ variants, onCheck, onDeleteGroup, onUpdate, onVariantDeleted, ebayFailedIds, detailMode = false, onPriceMismatch, scraperUsage = {}, scraperHistory = {} }) {
